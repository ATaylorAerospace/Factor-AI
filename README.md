# ⚖️ Factor - Agentic AI Legal Due Diligence Platform 🔍
...
Factor deploys a system of **autonomous AI agents** that collaboratively analyze batches of legal documents:
...
> **DISCLAIMER:** Factor is an agentic AI research and productivity tool created by A Taylor. It does **NOT** provide legal advice. All analysis is generated by autonomous AI agents and may contain errors. The underlying knowledge base is powered by a **synthetic dataset** (Taylor658/synthetic-legal on HuggingFace) - **all content including citations, statutes, and case references is artificially generated and not legally accurate.** Always consult a qualified attorney for legal matters. Use of this tool does not create an attorney-client relationship.
